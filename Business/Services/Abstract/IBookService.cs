...
public interface IBookService
{
    ...
    Task<IDataResult<IEnumerable<ListBookViewModel>>> GetAllBooksAsync(Expression<Func<Book, bool>> predicate, CancellationToken ct);
    Task<IDataResult<IEnumerable<ListBookViewModel>>> GetAllBooksWithAuthorAsync(Expression<Func<Book, bool>> predicate, CancellationToken ct);
